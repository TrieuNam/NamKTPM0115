...
\author{\IEEEauthorblockN{1\textsuperscript{st} Luong Khiem Tran}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{Ho Chi Minh City University of Technology}\\
Ho Chi Minh city, Vietnam \\
7140242@hcmut.edu.vn}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Ha Xuan Son}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{Ho Chi Minh City University of Technology}\\
Ho Chi Minh city, Vietnam \\
hxson@ctuet.edu.vn}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Tran Khanh Dang}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{Ho Chi Minh City University of Technology}\\
Ho Chi Minh city, Vietnam \\
khanh@hcmut.edu.vn}
\and
\IEEEauthorblockN{4\textsuperscript{th} Kim Tuyen Le}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{Ho Chi Minh City University of Technology}\\
Ho Chi Minh city, Vietnam \\
...
\begin{IEEEkeywords}
access control, healthcare system, break the glass, dynamic policy, rewriting request, policy evaluation
\end{IEEEkeywords}
