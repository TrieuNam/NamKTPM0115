		...
		MaxSATReasoner maxSATsolver = null;
			switch(choice){
				case 2: /*This is with hierarchy and may return different results compared to SACMAT 09...*/
						RBAC system = RBACInstantiations.generateRBACForComparison(true); 
						system.setupVarIDs();
						...
						RBACPermission[] lowerbound = new RBACPermission[]{perms[0]/*,perms[1]/*,perms[2]*/};
						RBACPermission[] upperbound = system.getPermissions();//new RBACPermission[]{perms[0]};
				...
				case 6: 
						...
						objExperiments.testCase("tests//configs//permission-test-MER.cfg" , 1, false, -1);
						//objExperiments.testCase("tests//configs//user-test-HRSoD.cfg" , 1,false, -1);
						/*objExperiments.testCase("tests//configs//role-test-MER.cfg" , 1,false,-1);
						objExperiments = new Experiments();*/
						//objExperiments.testCase("tests//configs//state-test-MER.cfg" , 1,false, -1);
						/*objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//session-test-MER.cfg" , 1, false, -1);
						objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//roleDRSoD-test.cfg" , 1,false,-1);
						objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//roleHRSoD-test.cfg" , 1,false,-1);
						objExperiments = new Experiments();*/
						//objExperiments.testCase("tests//configs//sessionDRSoD-test.cfg" , 1,false,-1);
						/*objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//sessionHRSoD-test.cfg" , 1,false,-1);*/
						/*objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//stateDRSoD-test.cfg" , 1,false,-1);
						objExperiments = new Experiments();
						objExperiments.testCase("tests//configs//stateHRSoD-test.cfg" , 1,false,-1);*/
						//objExperiments = new Experiments();
						//objExperiments.testCase("tests//configs//sacmat-test.cfg" , 1, true, -1);
						break;
				case 8:
