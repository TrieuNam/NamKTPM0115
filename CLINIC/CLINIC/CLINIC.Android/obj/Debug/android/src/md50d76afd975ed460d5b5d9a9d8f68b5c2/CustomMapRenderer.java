package md50d76afd975ed460d5b5d9a9d8f68b5c2;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CLINIC.Droid.Platform.CustomMapRenderer, CLINIC.Android", CustomMapRenderer.class, __md_methods);
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CLINIC.Droid.Platform.CustomMapRenderer, CLINIC.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public CustomMapRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CLINIC.Droid.Platform.CustomMapRenderer, CLINIC.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public CustomMapRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomMapRenderer.class)
			mono.android.TypeManager.Activate ("CLINIC.Droid.Platform.CustomMapRenderer, CLINIC.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
